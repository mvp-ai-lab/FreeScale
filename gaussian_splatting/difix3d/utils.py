...
class CameraPoseInterpolator:
    ...
    def find_nearest_assignments2(self, training_cams, testing_poses):
        """
        ...
        training_poses = [cam.cam_to_world for cam in training_cams]
        ref_poses = []
        ...
        for j in range(M):
            ...
            ref_poses.append(training_cams[nearest_index])
    ...
    def shift_poses(self, training_poses, testing_poses, distance=0.1, threshold=0.1):
        ...
        return np.array(novel_poses), train_index