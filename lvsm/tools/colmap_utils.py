...
if __name__=="__main__":
    ...
    # data_root = Path("/cephyr/users/qingwenz/Alvis/data/mipnerf360")
    # for scene in ["bicycle", "bonsai", "counter", "garden", "room", "stump", "flowers", "treehill"]:
    #     recon_path = data_root / scene / "sparse/0"
    #     output_dir = data_root / scene
    #     colmap_to_json(
    #         recon_path,
    #         output_dir,
    ...
    data_root = Path("/cephyr/users/qingwenz/Alvis/data/tanks_and_temples")
    for scene in ["Barn", "Caterpillar", "Family", "Francis", "Horse", "Ignatius", "Playground", "Train"]:
        recon_path = data_root / scene / "sparse/0"
        output_dir = data_root / scene
        colmap_to_json(
            recon_path,
