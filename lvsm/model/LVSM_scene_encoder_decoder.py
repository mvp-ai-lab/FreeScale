...
class Images2LatentScene(nn.Module):
    ...
    @torch.no_grad()
    def render_video(self, data_batch, data_path=None, traj_type="interpolate", num_frames=60, loop_video=False, order_poses=False, spiral_radius=0.5):
        """
        ...
        if traj_type == "interpolate":
            ...
            for b in range(bs):
                cur_c2ws, cur_intrinsics = camera_utils.generate_spiral_path(
                    ref_c2w[b], ref_fxfycxcy[b], num_frames, spiral_radius
                )
